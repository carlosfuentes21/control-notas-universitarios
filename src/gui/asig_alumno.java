 ...
 * @author USUARIO
 */
public class asig_alumno extends javax.swing.JFrame {

    l_alumno l;
    l_asignatura la;
    l_nota_semestre lns;
    notas_semestre temporal;
    private DefaultTableModel model;

    /**
     * Creates new form nota_semestre
     */
    public asig_alumno(l_alumno a, l_asignatura b, l_nota_semestre c) {
        initComponents();
    ...
    public void cargardetalles(detalle_asig d) {
        ...
        //************************************
        if (!temporal.ld.vacia()) {
            while (d != null) {
                Object[] fila = new Object[2];

                fila[0] = d.getAsig().getNom();
                fila[1] = d.getAsig().getCod();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ASIGNAR ASIGNATURA AL ALUMNO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 18))); // NOI18N
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(36, 36, 36)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(fac, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
                                    .addComponent(sex)))))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(174, 174, 174)
        ...
        if (doc.getText().equals("")) {
            ...
            if (a != null) {
                if (a.getDoc().equals(doc.getText()) && !a.getest().equals("inactivo")) {
                    ...
                    sem.setText(Integer.toString(Integer.parseInt(a.getSem() + 1)));
                    fac.setText(a.getFac().getCod() + "-" + a.getFac().getNom());
                } else {
    ...
    private void iniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniActionPerformed
        ...
        if (!nom.getText().equals("") && fec.getDate() != null) {
            String z = fec.getDate().toString();
            System.out.println(z);
            String v[] = z.split(" ");
            String mes = v[1].trim();
            int dia = Integer.parseInt(v[2]);
            int año = Integer.parseInt(v[5]);

            if (v[1].equals("Jan") && dia >= 06 && dia <= 30) {
                alumno a = l.buscar(doc.getText());
                String fech = "1" + Integer.toString(año);
                temporal = new notas_semestre(fech, sem.getText(), "0", a);
                tabla.setEnabled(true);
                mat.setEnabled(true);
                can.setEnabled(true);
                ini.setEnabled(false);
            } else {
                if (v[1].equals("Jun") && dia >= 06 && dia <= 30) {
                    alumno a = l.buscar(doc.getText());
                    String fech = "2" + Integer.toString(año);
                    String fecha = Integer.toString(dia) + "/" + mes + Integer.toString(año);
                    temporal = new notas_semestre(fech, sem.getText(), "0", a);
                    tabla.setEnabled(true);
                    mat.setEnabled(true);
                    fin.setEnabled(true);
    ...
    private void matActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matActionPerformed
        ...
        try {
            ...
            if (filaseleccionada == -1) {
                ...
                detalle_asig dt = new detalle_asig(as, "0");
                temporal.ld.ins_asig(dt);
                cargardetalles(temporal.ld.retunrcab());
